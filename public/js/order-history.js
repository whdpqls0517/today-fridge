(function () {
  ...
  function cardHTML(order) {
    ...
    if (order.viewStatus.group === "progress") actions.push(`<a href="./index.html#receipt">수령 확인증</a>`);
  ...
  function openDetail(orderId) {
    ...
    detailContent.querySelector("[data-copy-bank-account]")?.addEventListener("click", copyTransferAccount);
