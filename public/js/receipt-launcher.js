(function () {
  ...
  function openReceipt(event) {
    const link = event.target.closest('a[href*="index.html#receipt"]');
  ...
  window.openReceiptOverlay = function () {
    openReceipt({
      target: {
        closest(selector) {
          return selector.includes("index.html#receipt") ? document.createElement("a") : null;
        }
      },
      preventDefault() {}
    });
